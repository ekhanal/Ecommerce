...
<header class="header">
    ...
    <section class="flex">
        ...
        <a href="home.php" class="logo">Electronic Nepal<span></span></a>
        ...
        <div class="icons">
            ...
            <a href="wishlist.php"><i class="fas fa-heart"></i>Wishlist<span>(<?= $total_wishlist_counts; ?>)</span></a>
            <a href="cart.php"><i class="fas fa-shopping-cart"></i>Cart<span>(<?= $total_cart_counts; ?>)</span></a>
